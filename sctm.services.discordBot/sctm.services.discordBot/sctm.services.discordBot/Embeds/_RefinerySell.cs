...
namespace sctm.services.discordBot
{
    ...
    {
        public static DiscordEmbed RefinerySellEmbed(sctm.connectors.azureComputerVision.models.Terminals.Refinery.Sell data, MessageCreateEventArgs e, DiscordAttachment attachment, string avatarUrl, string recordId)
        {
            ...
            var _ret = new DiscordEmbedBuilder
            {
                ...
                Footer = new DiscordEmbedBuilder.EmbedFooter { Text = $"Star Citizen Tools by SC TradeMasters >> Terminals_RefinerySell:{recordId}", IconUrl = avatarUrl }
            }
