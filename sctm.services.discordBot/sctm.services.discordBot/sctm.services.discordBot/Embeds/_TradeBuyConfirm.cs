...
namespace sctm.services.discordBot
{
    ...
    {
        public static DiscordEmbed TradeBUYConfirm(sctm.connectors.azureComputerVision.models.Terminals.Trade.Confirm data, MessageCreateEventArgs e, DiscordAttachment attachment, string avatarUrl, string recordId)
        {
            ...
            var _ret = new DiscordEmbedBuilder
            {
                ...
                Footer = new DiscordEmbedBuilder.EmbedFooter { Text = $"Star Citizen Tools by SC TradeMasters >> Terminals_TradeBuyConfirm:{recordId}", IconUrl = avatarUrl }
            }
