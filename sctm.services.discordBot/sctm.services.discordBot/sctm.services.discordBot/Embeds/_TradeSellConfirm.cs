...
namespace sctm.services.discordBot
{
    ...
    {
        public static DiscordEmbed TradeSELLConfirm(sctm.connectors.azureComputerVision.models.Terminals.Trade.Confirm data, MessageCreateEventArgs e, DiscordAttachment attachment, string avatarUrl)
        {
