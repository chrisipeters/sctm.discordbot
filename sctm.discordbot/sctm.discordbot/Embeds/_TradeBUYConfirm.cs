...
namespace sctm.discordbot
{
    ...
    {
        public static DiscordEmbed TradeBUYConfirm(connectors.azureComputerVision.models.Terminals.Trade.Confirm data, MessageCreateEventArgs e, DiscordAttachment attachment, string avatarUrl)
        {
